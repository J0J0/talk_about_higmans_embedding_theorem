...
\usepackage[pdftex,bookmarks,colorlinks=false,pdfborder={0 0 0},%
            pdftitle={Seminar: Das Wortproblem - %
                      Handout zu Vortrag 10: Der Einbettungssatz von Higman},%
...
\newtheorem{thDefProposition}[globalnum]{Definition/Proposition}
...
\setlist[itemize,1]{label=--,topsep=2pt,parsep=0pt,itemsep=2pt,leftmargin=2em}
...
%\enlargethispage{2cm}
\small
\nocite{bookc:rotman95}
\nocite{paper:aanderaa73}
